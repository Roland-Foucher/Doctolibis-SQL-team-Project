...
INSERT INTO `apm_type` VALUES (1,'PRESENTIEL'),(2,'VISIO');
...
INSERT INTO `appointment` VALUES (12,'2020-10-10',1,1,1);
...
CREATE TABLE `medecin` (
  ...
  `legalMention` varchar(50) NOT NULL,
...
INSERT INTO `medecin` VALUES (1,'232',12,'blouop','medecin generaliste blablabla',2),(5,'chirurgien',10,'adresse','presentation',1);
...
CREATE TABLE `patient` (
  ...
  `secuNumber` varchar(50) NOT NULL,
  `user_id` int(11) NOT NULL,
...
INSERT INTO `patient` VALUES (1,'8908908263276',1),(2,'1111111111',2);
...
-- Dump completed on 2022-01-10 17:07:02
